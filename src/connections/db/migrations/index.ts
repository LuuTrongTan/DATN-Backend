...
import * as migration023 from './20251122_000001_create_app_settings_table';
...
export const migrations: MigrationInfo[] = [
  ...
  { name: '20251122_000001_add_variant_id_to_product_media', migration: migration021.migration },
  { name: '20251122_000002_add_order_items_snapshot', migration: migration022.migration },
  { name: '20251122_000001_create_app_settings_table', migration: migration023.migration },
];
