...
import * as migration016 from './20251120_000016_create_shipping_table';
import * as migration017 from './20251120_000017_create_refunds_table';
import * as migration018 from './20251120_000018_create_refund_items_table';
import * as migration019 from './20251120_000019_enable_vector_search';
import * as migration020 from './20251120_000020_create_payment_transactions_table';
import * as migration021 from './20251120_000021_create_notifications_table';
import * as migration022 from './20251120_000022_create_product_tags_table';
import * as migration023 from './20251120_000023_create_audit_logs_table';
import * as migration024 from './20251120_000024_create_product_media_table';
...
export const migrations: MigrationInfo[] = [
  ...
  { name: '20251120_000016_create_shipping_table', migration: migration016.migration },
  { name: '20251120_000017_create_refunds_table', migration: migration017.migration },
  { name: '20251120_000018_create_refund_items_table', migration: migration018.migration },
  { name: '20251120_000019_enable_vector_search', migration: migration019.migration },
  { name: '20251120_000020_create_payment_transactions_table', migration: migration020.migration },
  { name: '20251120_000021_create_notifications_table', migration: migration021.migration },
  { name: '20251120_000022_create_product_tags_table', migration: migration022.migration },
  { name: '20251120_000023_create_audit_logs_table', migration: migration023.migration },
  { name: '20251120_000024_create_product_media_table', migration: migration024.migration },
];
